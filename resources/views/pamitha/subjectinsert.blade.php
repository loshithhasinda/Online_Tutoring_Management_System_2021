...
{{csrf_field()}}
  ...
  <select name="grade" id="" class="dk" >
   ...
   <input type="number"  name="qut"   class="dk"><br><br>
    ...
    <center>
          <button class="btn btn-success" >Insert <ion-icon name="add-outline"></ion-icon>
    ...
    <table class="table table-bordered table-striped table-dark"  >
        ...
        @if(($task->grade)<=9)
             <tr>
                 ...
                 <a href="/updatesubject/{{$task->id}}">
                 <button class="btn btn-warning"><ion-icon name="trending-up-outline"></ion-icon> update</button>
                 </th></a>
            </tr>
            @endif
        @endforeach
