                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lecturer" value="{{ $timetable->lecturer }}" placeholder="Enter name" required>
                                    @error('lecturer')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{ $timetable->title }}" placeholder="Enter title" required>
                                    @error('title')
                                        <span class="badge badge-danger text-capital">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="date" value="{{ $timetable->date }}" required>
                                    @error('date')
                                        <span class="badge badge-danger text-capital">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="time" value="{{ $timetable->time }}" required>
                                    @error('time')
                                        <span class="badge badge-danger text-capital">{{ $message }}</span>
                                    @enderror
                                </div>
